...
旗上げゲームの語彙は、「赤」「白」「あげて」「あげない」「さげて」「さ
げない」です。語彙リストは以下のように書けるでしょう。

flaggame-ja-lex.xml

.. literalinclude:: flaggame-ja-lex.xml

次に文法モデルを定義しましょう。旗上げゲームの入力は「赤あげて」「赤あ
げない」「赤さげて」「赤さげない」「白あげて」「白あげない」「白さげて」
「白さげない」のいずれかです。one-ofタグを使うことで各入力を記述しても
良いのですが、ここではよりコンパクトな文法を定義してみましょう。
